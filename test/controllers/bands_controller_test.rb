...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { artistic_director: @band.artistic_director, description: @band.description, imagePath: @band.imagePath, name: @band.name } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { artistic_director: @band.artistic_director, description: @band.description, imagePath: @band.imagePath, name: @band.name } }
